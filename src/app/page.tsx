                ...
                <div className="authentication-page w-full">
                    <main id="content" className="w-full max-w-md mx-auto p-6">
                        <Link href="/" className="header-logo lg:hidden">
                            <Image width={40} height={40} src="/assets/img/brand-logos/desktop-logo.png" alt="logo"
                                   className="mx-auto block dark:hidden"/>
                            <Image width={40} height={40} src="/assets/img/brand-logos/desktop-dark.png" alt="logo"
                            ...
                            <div className="p-4 sm:p-7">
                                <div className="text-center">
                                    ...
                                    <p className="mt-3 text-sm text-gray-600 ">
                                        ...
                                        <Link className="text-primary ml-1 decoration-2 hover:underline font-medium"
                                              href="/">
                                            Sign up here
                                        </Link>
                                    </p>
                                ...
                                <div className="mt-5">
                                    <button type="button"
                                        ...
                                        <Image width={20} height={20} src="/assets/img/authentication/social/1.png"
                                               className="w-4 h-4"
                                               alt="google-img"/>
                                        Sign in with Google
                                    </button>
