          ...
          <ul className="main-menu">
            ...
            <li className="slide  has-sub">
              ...
              <ul className="slide-menu child1">
                ...
                <li className="slide">
                  <a href="index12.html" className="side-menu__item">
                    Course
                  </a>
                </li>
              </ul>
            ...
            <li className="slide has-sub">
              ...
              <ul className="slide-menu child1">
                ...
                <li className="slide">
                  <a href="badges.html" className="side-menu__item">
                    Badges
                  </a>
                </li>
                <li className="slide">
                ...
                <li className="slide">
                  <a href="collapse.html" className="side-menu__item">
                    Collapse
                  </a>
                </li>
                <li className="slide">
                  <a href="list-group.html" className="side-menu__item">
                    ListGroup
                  </a>
                </li>
                <li className="slide">
                ...
                <li className="slide">
                  <a href="skeleton.html" className="side-menu__item">
                    Skeleton
                  </a>
                </li>
                <li className="slide">
                ...
                <li className="slide">
                  <a href="toast.html" className="side-menu__item">
                    Toast
                  </a>
                </li>
              </ul>
