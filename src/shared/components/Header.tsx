            ...
            <nav className="main-header" aria-label="Global">
                <div className="header-content">
                    ...
                    <div className="responsive-logo">
                        <a className="responsive-logo-dark" href="index.html" aria-label="Brand">
                            <img
                                src="../assets/img/brand-logos/desktop-logo.png" alt="logo" className="mx-auto"/>
                        </a>
                        <a className="responsive-logo-light" href="index.html" aria-label="Brand">
                            <img
                                src="../assets/img/brand-logos/desktop-dark.png" alt="logo" className="mx-auto"/>
                        </a>
                    </div>
                        ...
                        <div className="responsive-headernav">
                            <div className="header-nav-right">
                                <div className="header-country hs-dropdown ti-dropdown hidden sm:block"
                                    ...
                                    <div className="hs-dropdown-menu ti-dropdown-menu min-w-[10rem]"
                                ...
                                <div className="header-cart hs-dropdown ti-dropdown hidden lg:block"
                                     data-hs-dropdown-placement="bottom-right">
                                    <button id="dropdown-cart" type="button"
                                        ...
                                        <span
                                            className="flex absolute h-5 w-5 top-0 ltr:right-0 rtl:left-0 -mt-1 ltr:-mr-1 rtl:-ml-1">
                  <span
                      className="relative inline-flex rounded-full h-5 w-5 bg-danger text-white justify-center items-center"
                      id="cart-data2">4</span>
                </span>
                                    </button>
                                    <div className="hs-dropdown-menu ti-dropdown-menu w-[20rem] border-0"
                                         aria-labelledby="dropdown-cart">
                                        <div
                                            className="ti-dropdown-header !bg-primary border-b dark:border-white/10 flex justify-between items-center">
                                            <p className="ti-dropdown-header-title !text-white font-semibold">Shopping
                                                Cart</p>
                                            <a href="javascript:void(0)"
                                               className="badge bg-black/20 text-white rounded-sm" id="cart-data">4
                                                Items</a>
                                        </div>
                                        <div
                                            className="ti-dropdown-divider divide-y divide-gray-200 dark:divide-white/10">
                                                       ...
                                                       className="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="flex space-x-2 rtl:space-x-reverse">
                                                                ...
                                                                <span
                                                                    className="my-auto line-through text-xs text-gray-400 dark:text-white/70">$999</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                       ...
                                                       className="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="flex space-x-2 rtl:space-x-reverse">
                                                                ...
                                                                <span
                                                                    className="my-auto line-through text-xs text-gray-400 dark:text-white/70">$599</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                    <a aria-label="anchor" href="javascript:void(0);"
                                                       ...
                                                       className="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="flex space-x-2 rtl:space-x-reverse">
                                                                ...
                                                                <span
                                                                    className="my-auto line-through text-xs text-gray-400 dark:text-white/70">$399</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                    <a aria-label="anchor" href="javascript:void(0);"
                                                       ...
                                                       className="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="flex space-x-2 rtl:space-x-reverse">
                                                                ...
                                                                <span
                                                                    className="my-auto line-through text-xs text-gray-400 dark:text-white/70">$150</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                    <a aria-label="anchor" href="javascript:void(0);"
                                            ...
                                            <div className="py-2 first:pt-0 last:pb-0 px-5">
                                                <div className="flex justify-between">
                                                    <div>
                                                        <span
                                                            className="text-xs font-semibold text-gray-800 dark:text-white">Total</span>
                                                    </div>
                                                    <div className="text-end font-medium">
                                                        <span
                                                            className="text-xs font-semibold text-gray-800 dark:text-white">$40,020</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="py-2 first:pt-0 px-5">
                                                <a className="w-full ti-btn ti-btn-primary p-2" href="checkout.html">
                                                    Proceed Checkout
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div className="header-notification hs-dropdown ti-dropdown hidden sm:block"
                                     data-hs-dropdown-placement="bottom-right">
                      ...
                      id="notify-data">4</span>
                                    ...
                                    <div className="hs-dropdown-menu ti-dropdown-menu w-[20rem] border-0"
                                        ...
                                        <div
                                            ...
                                            <a href="javascript:void(0)"
                                               className="badge bg-black/20 text-white rounded-sm">Mark All Read</a>
                                        </div>
                                        <div
                                            className="ti-dropdown-divider divide-y divide-gray-200 dark:divide-white/10">
                                                    ...
                                                    <a href="mail-inbox.html"
                                                       className="flex space-x-3 rtl:space-x-reverse">
                                                        ...
                                                        <div className="relative w-full">
                                                            <h5 className="text-sm text-gray-800 dark:text-white font-semibold mb-1">Elon
                                                                Isk</h5>
                                                            <p className="text-xs mb-1 max-w-[200px] truncate">Hello
                                                                there! How are you doing? Call me when...</p>
                                                            <p className="text-xs text-gray-400 dark:text-white/70">2
                                                                min</p>
                                                        </div>
                                                    </a>
                                                    <a aria-label="anchor" href="javascript:void(0);"
                                                ...
                                                <div className="ti-dropdown-item relative header-box">
                                                    <a href="mail-inbox.html"
                                                       className="flex items-center space-x-3 rtl:space-x-reverse">
                                                        ...
                                                        <div className="relative w-full">
                                                            <h5 className="text-sm text-gray-800 dark:text-white font-semibold mb-1">Shakira
                                                                Sen</h5>
                                                            <p className="text-xs mb-1 max-w-[200px] truncate">I would
                                                    ...
                                                    <a href="mail-inbox.html"
                                                       className="flex items-center space-x-3 rtl:space-x-reverse">
                                                        ...
                                                        <div className="relative w-full">
                                                            ...
                                                            <p className="text-xs mb-1 max-w-[200px] truncate">Shall we
                                                ...
                                                <div className="ti-dropdown-item relative header-box">
                                                    <a href="mail-inbox.html"
                                                       className="flex items-center space-x-3 rtl:space-x-reverse">
                                                        ...
                                                        <div className="relative w-full">
                                                            <h5 className="text-sm text-gray-800 dark:text-white font-semibold mb-1">Charlie
                                                                Davieson</h5>
                                                            <p className="text-xs mb-1 max-w-[200px] truncate">Lorem
                                            ...
                                            <div className="py-2 first:pt-0 px-5">
                                                <a className="w-full ti-btn ti-btn-primary p-2" href="mail-inbox.html">
                                                    View All
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div className="header-apps hs-dropdown ti-dropdown hidden md:block"
                                     data-hs-dropdown-placement="bottom-right">
                                    ...
                                    <div className="hs-dropdown-menu ti-dropdown-menu w-[20rem] border-0"
                                        ...
                                        <div
                                            ...
                                            <p className="ti-dropdown-header-title font-semibold !text-white">Related
                                                Apps</p>
                                        </div>
                                        <div
                                            className="ti-dropdown-divider divide-y divide-gray-200 dark:divide-white/10">
                                            <div className="grid grid-cols-3 gap-0 p-4 pt-2">
                                                <a href="mail-inbox.html"
                                                   className="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50 dark:hover:bg-black/20">
                                                    ...
                                                    <div
                                                        className="text-xs font-semibold text-gray-800 dark:text-white">Mail
                                                        Inbox
                                                    </div>
                                                </a>
                                                <a href="chat.html"
                                                   className="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50 dark:hover:bg-black/20">
                                                    ...
                                                    <div
                                                        className="text-xs font-semibold text-gray-800 dark:text-white">Chat
                                                    </div>
                                                </a>
                                                <a href="tasks.html"
                                                   className="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50 dark:hover:bg-black/20">
                                                    ...
                                                    <div
                                                        className="text-xs font-semibold text-gray-800 dark:text-white">Task
                                                    </div>
                                                </a>
                                                <a href="calendar.html"
                                                   className="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50 dark:hover:bg-black/20">
                                                    ...
                                                    <div
                                                        className="text-xs font-semibold text-gray-800 dark:text-white">Calendar
                                                    </div>
                                                </a>
                                                <a href="filemanager.html"
                                                   className="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50 dark:hover:bg-black/20">
                                                    ...
                                                    <div
                                                        className="text-xs font-semibold text-gray-800 dark:text-white">FileManager
                                                    </div>
                                                </a>
                                                <a href="contacts.html"
                                                   className="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50 dark:hover:bg-black/20">
                                                    ...
                                                    <div
                                                        className="text-xs font-semibold text-gray-800 dark:text-white">Contacts
                                                    </div>
                                                </a>
                                            </div>
                                            <div className="py-2 first:pt-0 px-5">
                                                <a className="w-full ti-btn ti-btn-primary p-2"
                                ...
                                <div className="header-profile hs-dropdown ti-dropdown"
                                     data-hs-dropdown-placement="bottom-right">
                                    ...
                                    <div className="hs-dropdown-menu ti-dropdown-menu border-0 w-[20rem]"
                                        ...
                                        <div className="ti-dropdown-header !bg-primary flex">
                                            ...
                                            <div>
                                                ...
                                                <p className="ti-dropdown-header-content !text-white/50">Web
                                                    Designer</p>
                                            </div>
                                        </div>
