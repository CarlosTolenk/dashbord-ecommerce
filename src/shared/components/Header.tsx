                  ...
                  <div className="header-nav-right">
                    ...
                    <div className="header-search" >
                      <button aria-label="button" type="button" data-hs-overlay="#search-modal"
                              className="inline-flex flex-shrink-0 justify-center items-center gap-2 h-[2.375rem] w-[2.375rem] rounded-full font-medium active:bg-gray-100 hover:bg-gray-200 text-gray-500 align-middle focus:outline-none focus:ring-0 focus:ring-gray-400 focus:ring-offset-0 focus:ring-offset-white transition-all text-xs dark:bg-bgdark dark:hover:bg-black/20 dark:text-white/70 dark:hover:text-white dark:focus:ring-white/10 dark:focus:ring-offset-white/10">
                      ...
                      <div className="hs-dropdown-menu ti-dropdown-menu w-[20rem] border-0" aria-labelledby="dropdown-cart">
                        ...
                        <div className="ti-dropdown-divider divide-y divide-gray-200 dark:divide-white/10">
                            ...
                            {cartItems.map((idx) => (
                                <div className="ti-dropdown-item relative header-box" key={Math.random()}>
                                  <Link  href="#!" className="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                    <img src={`${process.env.NODE_ENV === "production" ? basePath : ""}${idx.src}`} alt="product-img" className="avatar p-2 shadow-none  shrink-0 items-center justify-center rounded-sm active:bg-gray-100 dark:bg-black/20 !ring-transparent" />
                                    <div>
                                  ...
                                  <Link aria-label="anchor" href="#!" onClick={() => handleRemove(idx.id)} className="header-remove-btn ltr:ml-auto rtl:mr-auto flex-shrink-0 inline-flex items-center justify-center text-lg text-gray-500/20 dark:text-white/20 hover:text-gray-800 dark:hover:text-white">
                          ...
                          <div className={`py-2 first:pt-0 px-5 ${cartItemCount === 0 ? 'hidden' : 'd-block'}`}>
                            <Link className="w-full ti-btn ti-btn-primary p-2" href={"/components/pages/ecommerce/checkout/"}>
                              Proceed Checkout
                            </Link>
                          </div>
                          <div className={`p-6 pb-2 empty-item ${cartItemCount === 0 ? 'd-block' : 'hidden'}`}>
                    ...
                    <div className="header-notification hs-dropdown ti-dropdown hidden sm:block" data-hs-dropdown-placement="bottom-right">
                      ...
                      <div className="hs-dropdown-menu ti-dropdown-menu w-[20rem] border-0" aria-labelledby="dropdown-notification">
                        ...
                        <div className="ti-dropdown-divider divide-y divide-gray-200 dark:divide-white/10">
                          <div className="py-2 first:pt-0 last:pb-0" id="allNotifyContainer">
                            {notifications.map((idx, index) => (
                                <div className="ti-dropdown-item relative header-box" key={index}>
                                  ...
                                  <Link onClick={() => handleNotificationClose(index)} aria-label="anchor" href="#!" className="header-remove-btn ltr:ml-auto rtl:mr-auto text-lg text-gray-500/20 dark:text-white/20 hover:text-gray-800 dark:hover:text-white">
                                    <i className="ri-close-circle-line"></i>
                                  </Link>
                                </div>
                            ))}
                          ...
                          <div className={`p-5 empty-item1 ${notifications.length === 0 ? 'd-block' : 'hidden'}`}>
                    ...
                    <div className="switcher-icon">
                      <button aria-label="button" type="button" className="hs-dropdown-toggle inline-flex flex-shrink-0 justify-center items-center gap-2 h-[2.375rem] w-[2.375rem] rounded-full font-medium active:bg-gray-100 hover:bg-gray-200 text-gray-500 align-middle focus:outline-none focus-visible:outline-none focus:ring-0 focus:ring-gray-400 focus:ring-offset-0 focus:ring-offset-white transition-all text-xs dark:bg-bgdark dark:hover:bg-black/20 dark:text-white/70 dark:hover:text-white dark:focus:ring-white/10 dark:focus:ring-offset-white/10" data-hs-overlay="#hs-overlay-switcher">
